...
```
cd existing_repo
git remote add origin https://cicd.skyway.porsche.com/PG50/bonsai_ws.git
git branch -M main
...
- [ ] [Set up project integrations](https://cicd.skyway.porsche.com/PG50/bonsai_ws/-/settings/integrations)
